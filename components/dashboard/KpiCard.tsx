        ...
        <div>
          ...
          <div className="grid grid-cols-2 gap-2 mt-3">
            <div className="min-w-0">
              ...
              <div className="text-lg xl:text-xl font-extrabold text-blue-600 tracking-tight mt-0.5 truncate">
            ...
            <div className="min-w-0">
              ...
              <div className="text-lg xl:text-xl font-extrabold text-emerald-600 tracking-tight mt-0.5 truncate">
